...
function List() {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_URL}/app/list`, body, {
        headers: {
  ...
  return (
    <div>
      <img
        src={booknobg}
        alt="logo"
        className="card w-24 rounded-lg left-1/2 transform -translate-x-1/2 mt-2 mt-5 mb-5 saturate-200 glass justify-center"
      />
