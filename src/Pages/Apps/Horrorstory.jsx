...
function Horrorstory() {
  ...
  const getHorrorstory = async () => {
    try {
      let response = await axios.get(`${process.env.REACT_APP_API_URL}/app/horrorstory`);
...
const token = localStorage.getItem('authToken');
  ...
  return (
    <div>
      ...
      {/* <h2>{prompt}</h2> */}
      <h2 className='mt-2'>Creates two to three sentence short horror stories from a topic input.</h2>
