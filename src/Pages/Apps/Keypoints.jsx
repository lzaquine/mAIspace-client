...
const token = localStorage.getItem('authToken');
  ...
  return (
    <div>
      ...
      {/* <h2>{prompt}</h2> */}
      <h2 className='mt-2'>Keypoints</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="text" name="question" className='input input-bordered w-full rounded-lg max-w-xs mt-1 mb-3 mt-8 text-center text-neutral-400 opacity-95 justify-center' placeholder="5 Keypoints of something" onChange={(e) => setQuestion(e.target.value)} value={question} /><br/>
