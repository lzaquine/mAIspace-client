    ...
    <Link to='/'>
      ...
      <div className="hidden md:flex md:items-center md:w-auto w-full" id="menu">
        <ul className="md:flex items-center justify-between text-base pt-4 md:pt-0">
          <li>
            <Link to='/' className="text-black px-4 hover:text-[#53595c]">HOME</Link>
          </li>
          <li  className="underline">
            <Link to='/about' className="px-4 text-[#66b1d6] hover:text-[#4e98bd]">ABOUT</Link>
          </li>
          {!loggedIn && (
          <li>
            <Link to='/signup' className="px-4 text-black hover:text-[#53595c]">SIGN UP</Link>
          </li>
          )}
          {loggedIn && (
            <>
      ...
      {isMenuOpen && (
        <div className="absolute top-10 left-0 right-0 bg-white z-10 shadow-md">
          <ul className="flex flex-col items-center">
            <li className="">
              <Link to='/' className="block px-4 text-black hover:text-[#53595c]">HOME</Link>
            </li>
            <li className="underline">
              <Link to='/about' className="block px-4  text-[#66b1d6] hover:text-[#4e98bd]">ABOUT</Link>
            </li>
            {!loggedIn && (
          <li>
            <Link to='/signup' className="px-4 text-black hover:text-[#53595c]">SIGN UP</Link>
