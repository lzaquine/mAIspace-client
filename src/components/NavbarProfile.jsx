...
function Navbar() {
  ...
  return (
    <nav className="flex justify-between items-center py-4 px-8">
      ...
      <div className="hidden md:flex md:items-center md:w-auto w-full" id="menu">
        <ul className="md:flex items-center justify-between text-base pt-4 md:pt-0">
          ...
          <li  className="underline">
            <Link to='/profile' className="px-4 text-[#66b1d6] hover:text-[#4e98bd]">PROFILE</Link>
          </li>
          <li  className="">
            <Link to='/editprofile' className="px-4 text-black hover:text-[#53595c]">EDIT PROFILE</Link>
          </li>
            <li>
      ...
      {isMenuOpen && (
        <div className="absolute top-14 left-0 right-0 bg-white z-10 shadow-md">
